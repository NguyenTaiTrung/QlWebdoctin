...
{
    public partial class MeNu_ThemMoiControl : System.Web.UI.UserControl
    {
        ...
        private void HienThiThongTin(string id)
        {
            if (thaotac == "chinhsua")
            {
                ...
                dt = Qlwebdoctin.Qldoctin.Add_Code.Database.MN.Thongtin_Menu_by_id(id);
                if (dt.Rows.Count > 0)
                {
        ...
        protected void btThemMoi_Click(object sender, EventArgs e)
        {
            if (thaotac == "themmoi")
            {
                ...
                Qlwebdoctin.Qldoctin.Add_Code.Database.MN.Menu_Inser(
            ...
            else
            {
                ...
                Qlwebdoctin.Qldoctin.Add_Code.Database.MN.Menu_Update(id, tbTenMenu.Text, tbLienKet.Text,
                    ddlMenuCha.SelectedValue, tbThuTu.Text);
