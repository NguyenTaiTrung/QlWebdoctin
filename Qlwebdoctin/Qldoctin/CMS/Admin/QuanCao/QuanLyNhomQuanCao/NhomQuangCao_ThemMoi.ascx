<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NhomQuangCao_ThemMoi.ascx.cs" Inherits="Qlwebdoctin.Qldoctin.CMS.Admin.QuanCao.QuanLyNhomQuanCao.NhomQuangCao_ThemMoi" %>
<div class="head">
