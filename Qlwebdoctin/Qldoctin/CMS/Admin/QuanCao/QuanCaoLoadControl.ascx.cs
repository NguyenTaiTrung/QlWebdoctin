...
namespace Qlwebdoctin.Qldoctin.CMS.Admin.QuanCao
{
    public partial class QuanCaoLoadControl : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                case "nhomquangcao":
                    plQuanCaoLoadControl.Controls.Add(LoadControl("QuanLyNhomQuanCao/NhomQuangCaoLoadControl.ascx"));
                    break;
                case "danhsachquangcao":
                    plQuanCaoLoadControl.Controls.Add(LoadControl("QuanLyDanhSachQuanCao/DanhSachQuanCaoLoadControl.ascx"));
                    break;
                default:
                    plQuanCaoLoadControl.Controls.Add(LoadControl("QuanLyNhomQuanCao/NhomQuangCaoLoadControl.ascx"));
                    break;
