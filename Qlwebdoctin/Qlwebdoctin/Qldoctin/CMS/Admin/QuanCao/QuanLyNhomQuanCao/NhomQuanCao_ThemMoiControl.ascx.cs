...
{
    public partial class NhomQuanCao_ThemMoiControl : System.Web.UI.UserControl
    {
        ...
        private void HienThiThongTin(string id)
        {
            if (thaotac == "chinhsua")
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    ltrAnhDaiDien.Text = "<img class='anhDaiDien'src='/pic/QuangCao/" + dt.Rows[0]["AnhDaiDien"] + @"'/>";
